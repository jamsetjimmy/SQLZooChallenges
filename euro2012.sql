...
INSERT INTO dbo.game (id, mdate, stadium, team1, team2)
VALUES
...
IF OBJECT_ID('dbo.eteam', 'U') IS NOT NULL
    DROP TABLE dbo.eteam;
GO

CREATE TABLE dbo.eteam (
  id VARCHAR(3),
  teamname VARCHAR(50),
  coach VARCHAR(50)
);
...
-- Inserting data into table 'eteam'
INSERT INTO dbo.eteam (id, teamname, coach)
VALUES
...
IF OBJECT_ID('dbo.goal', 'U') IS NOT NULL
    DROP TABLE dbo.goal;
GO
...
-- Inserting data into table 'goal'
INSERT INTO dbo.goal (matchid, teamid, player, gtime)
VALUES
